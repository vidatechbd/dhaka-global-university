<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        ...
        <p class="text-sm text-gray-500 mt-1">Join our university certificate platform today</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <!-- Name -->
        <div>
            <label for="name" class="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">
                {{ __('Full Name') }}
            </label>
            <div class="relative">
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">
                {{ __('Confirm Password') }}
            </label>
            <div class="relative">
                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
    ...
    <div class="mt-6 pt-5 border-t border-gray-100 text-center text-sm text-gray-500">
        ...
        <a href="{{ route('login') }}" class="font-semibold text-[#0a3a60] hover:text-[#f7941d] transition-colors duration-200">
            {{ __('Sign in') }}
        </a>
    </div>
</x-guest-layout>
