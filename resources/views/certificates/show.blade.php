        ...
        <div class="py-6 max-w-7xl mx-auto w-full">
            <div class="flex items-center justify-between mb-6 no-print">
                ...
                <button onclick="window.print()"
                    class="bg-primary hover:bg-primaryDark text-white px-5 py-2 rounded-lg font-bold transition flex items-center gap-2 shadow-md shadow-primary/20 text-sm">
...
@else
    ...
    <body class="bg-[#F0E8EE] font-sans min-h-screen flex flex-col items-center justify-center p-6 text-[#4C4C4C]">
        ...
        <div
            class="mb-6 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-full px-5 py-2 flex items-center gap-2 font-bold text-sm shadow-sm">
