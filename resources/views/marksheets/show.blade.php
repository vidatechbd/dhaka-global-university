        ...
        <div class="py-6 max-w-5xl mx-auto w-full">
            ...
            <div id="printable-transcript"
                ...
                <div class="absolute inset-0 z-0 flex justify-center items-center pointer-events-none"
                    ...
                    @else
                        <span
                            style="font-size:120px; font-weight:900; color:#0a3a60; letter-spacing:-4px; white-space:nowrap; transform:rotate(-30deg);">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <div class="w-20">
                                ...
                                @else
                                    <div
                                        style="width:72px;height:72px;display:flex;align-items:center;justify-content:center;background:#0a3a60;color:white;font-size:28px;border-radius:4px;">
                                        🎓</div>
                                @endif
                            </div>
                        ...
                        <div class="mb-3 text-[12px] leading-[1.3] w-[85%]">
                            <div class="flex mb-[1px]">
                                ...
                                <div class="font-bold uppercase">
                                    {{ $marksheet->student?->name ?? $marksheet->student_name ?? '—' }}</div>
                            </div>
                            ...
                            <div class="flex mb-[1px]">
                                ...
                                <div class="w-4 font-bold">:</div>
                                <div class="font-bold">
                                    {{ $marksheet->reg_no ?? '—' }}{{ $marksheet->session ? ' - ' . $marksheet->session : '' }}
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="flex justify-between items-end mt-6">
                            ...
                            <div class="flex flex-col items-center">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data={{ urlencode(route('marksheets.verify', $marksheet)) }}"
                                    alt="QR Code" class="w-16 h-16 border border-gray-300 p-1 bg-white">
                            ...
                            <div class="text-center w-36 flex flex-col items-center">
                                <div class="h-8 w-28 flex items-end justify-center mb-1">
                                    @if($setting->marksheet_prepared_by)
                                        <img src="{{ asset($setting->marksheet_prepared_by) }}" alt="Prepared By"
                                            class="max-h-full max-w-full object-contain">
                                    @endif
                                </div>
                                <div class="border-t border-black font-bold pt-1 text-[12px] italic w-full">Prepared by
                                </div>
                            </div>
                            ...
                            <div class="text-center w-36 flex flex-col items-center">
                                <div class="h-8 w-28 flex items-end justify-center mb-1">
                                    @if($setting->marksheet_compared_by)
                                        <img src="{{ asset($setting->marksheet_compared_by) }}" alt="Compared By"
                                            class="max-h-full max-w-full object-contain">
                                    @endif
                                </div>
                                <div class="border-t border-black font-bold pt-1 text-[12px] italic w-full">Compared by
                                </div>
                            </div>
                                ...
                                <div class="h-8 w-36 flex items-end justify-center mb-1">
                                    @if($setting->marksheet_controller_signature)
                                        <img src="{{ asset($setting->marksheet_controller_signature) }}"
                                            alt="Controller Signature" class="max-h-full max-w-full object-contain">
                                    @endif
                                </div>
                                <div class="border-t border-black font-bold pt-1 text-[12px] italic w-full">Controller of
                                    Examinations</div>
                            </div>
                        </div>
...
@else
    ...
    <body class="bg-[#F0E8EE] font-sans min-h-screen flex flex-col items-center justify-center p-6 text-[#4C4C4C]">
        ...
        <div class="flex items-center gap-4 mb-6 no-print">
            <div
                class="bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-full px-5 py-2 flex items-center gap-2 font-bold text-sm shadow-sm">
        ...
        <div id="printable-transcript" class="bg-white relative mx-auto overflow-hidden shadow-xl"
            style="width:210mm; min-height:297mm; padding:10mm 15mm; font-family:'Times New Roman',Times,serif; box-sizing:border-box;">
            ...
            <div class="relative z-10 text-black flex flex-col justify-between" style="min-height: 277mm;">
                <div>
                    ...
                    {{-- Academic Table --}}
                    <table class="w-full border-collapse border border-black text-[10px] mb-3" style="line-height:1.15;">
                        <thead>
                            <tr class="bg-gray-50">
                                <th class="border border-black py-1 px-1 font-bold text-center w-14">YEAR</th>
                                <th class="border border-black py-1 px-1 font-bold text-center w-20">COURSE CODE</th>
                ...
                <div>
                    <div class="flex justify-between items-end mt-6">
                        ...
                        <div class="text-center w-44 flex flex-col items-center">
                            <div class="h-8 w-36 flex items-end justify-center mb-1">
                                @if($setting->marksheet_controller_signature)
                                    <img src="{{ asset($setting->marksheet_controller_signature) }}" alt="Controller Signature"
                                        class="max-h-full max-w-full object-contain">
                                @endif
                            </div>
                            <div class="border-t border-black font-bold pt-1 text-[12px] italic w-full">Controller of
