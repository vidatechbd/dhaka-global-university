...
<body class="bg-bgclr-100 font-sans flex h-screen overflow-hidden text-textclr-100">
    ...
    >
        ...
        <nav class="flex-1 py-4 overflow-y-auto overflow-x-hidden">
            <ul class="space-y-1 px-3">
                ...
                @can('manage notices')
                    <li>
                        <button class="nav-link w-full flex items-center justify-between px-3 py-2.5 rounded-xl transition-all duration-200 submenu-toggle focus:outline-none {{ request()->routeIs('admin.notices.*') ? 'text-white bg-primary-300 font-semibold shadow-sm' : 'text-textclr-200 hover:bg-bgclr-300/20 hover:text-textclr-100' }}">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('admin.notices.*') ? 'text-white' : 'text-textclr-200' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Submenu Wrapper -->
                        <div class="sidebar-text transition-opacity duration-200">
                            <ul class="submenu-content space-y-1 mt-1 {{ request()->routeIs('admin.notices.*') ? '' : 'hidden' }}">
                                <li>
                                    <a href="{{ route('admin.notices.index') }}" class="flex items-center pl-11 pr-3 py-2 text-sm font-semibold rounded-xl transition-colors {{ request()->routeIs('admin.notices.index') ? 'text-white bg-primary-300 font-semibold shadow-sm' : 'text-textclr-200 hover:text-textclr-100 hover:bg-bgclr-300/20' }}">
                                        All notices
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.notices.create') }}" class="flex items-center pl-11 pr-3 py-2 text-sm font-semibold rounded-xl transition-colors {{ request()->routeIs('admin.notices.create') ? 'text-white bg-primary-300 font-semibold shadow-sm' : 'text-textclr-200 hover:text-textclr-100 hover:bg-bgclr-300/20' }}">
                                        Create notice
                                    </a>
                                </li>
                            </ul>
                ...
                @can('manage gallery')
                    <li>
                        <button class="nav-link w-full flex items-center justify-between px-3 py-2.5 rounded-xl transition-all duration-200 submenu-toggle focus:outline-none {{ request()->routeIs('admin.gallery.*') ? 'text-white bg-primary-300 font-semibold shadow-sm' : 'text-textclr-200 hover:bg-bgclr-300/20 hover:text-textclr-100' }}">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('admin.gallery.*') ? 'text-white' : 'text-textclr-200' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Submenu Wrapper -->
                        <div class="sidebar-text transition-opacity duration-200">
                            <ul class="submenu-content space-y-1 mt-1 {{ request()->routeIs('admin.gallery.*') ? '' : 'hidden' }}">
                                <li>
                                    <a href="{{ route('admin.gallery.index') }}" class="flex items-center pl-11 pr-3 py-2 text-sm font-semibold rounded-xl transition-colors {{ request()->routeIs('admin.gallery.index') ? 'text-white bg-primary-300 font-semibold shadow-sm' : 'text-textclr-200 hover:text-textclr-100 hover:bg-bgclr-300/20' }}">
                                        All gallery items
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.gallery.create') }}" class="flex items-center pl-11 pr-3 py-2 text-sm font-semibold rounded-xl transition-colors {{ request()->routeIs('admin.gallery.create') ? 'text-white bg-primary-300 font-semibold shadow-sm' : 'text-textclr-200 hover:text-textclr-100 hover:bg-bgclr-300/20' }}">
                                        Add image
                                    </a>
                                </li>
                            </ul>
    ...
    <main class="flex-1 flex flex-col overflow-hidden bg-bgclr-100">
        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto p-8 max-w-7xl w-full mx-auto flex flex-col justify-between">
            ...
            <footer class="mt-12 border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-400">
