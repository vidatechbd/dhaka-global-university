<x-admin-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-3 w-full">
            <div>
                <h1 class="text-xl font-bold text-primary">{{ __('Create Page') }}</h1>
                <p class="text-xs text-slate-500 mt-0.5">Create a new page for the university website.</p>
            </div>
    ...
    <div class="max-w-4xl">
        <x-admin.card title="Page Details" subtitle="Fill in the details below to create a new page." icon="ph-bold ph-file-text">
            <form action="{{ route('admin.pages.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <x-text-input id="title" class="mt-2 w-full" type="text" name="title" :value="old('title')" required autofocus placeholder="e.g. Terms of Service" />
                ...
                <div>
                    ...
                    <x-text-input id="slug" class="mt-2 w-full" type="text" name="slug" :value="old('slug')" placeholder="e.g. terms-of-service" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="sort_order" class="mt-2 w-full" type="number" name="sort_order" :value="old('sort_order', 0)" min="0" required />
